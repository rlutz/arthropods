...
do	./arthropods --style=thickened \
	...
	./arthropods --row-count=2 --numbering-scheme=zigzag --style=psl \
	    --name=2x${pin_count}PIN_PSL --pin-count=$[$pin_count * 2] \
